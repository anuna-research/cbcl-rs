...
def main (args : List String) : IO Unit := do
  ...
  | ["--test"] => do
    ...
    let tests := [
      ...
      ("(custom-perf alice data)", false),
      ("(signed signature (custom-perf alice data))", false),
      ("(lang demo (custom-perf alice data))", true),
      ("(lang demo (signed signature (custom-perf alice data)))", true),
      ("(signed signature (lang demo (custom-perf alice data)))", true),
      ("(lang outer (lang demo (custom-perf alice data)))", true),
