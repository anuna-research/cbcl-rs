...
lean_object* initialize_lean_x2dcbcl_LeanCbcl_R5(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_lean_x2dcbcl_LeanCbcl_R5(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
